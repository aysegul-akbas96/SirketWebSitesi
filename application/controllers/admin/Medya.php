...
class Medya extends CI_Controller {
  ...
  $this->load->model('Database_Model');
	...
	{
		$query=$this->db->query("SELECT * FROM menu_alt where parent_id=2");
		...
		$this->load->view('admin/medya_listele',$data);
	...
	$query=$this->db->query("SELECT * FROM siteayarlari");
		...
		$this->load->view('admin/medya_ekle',$data);
...
public function ekle_kaydet()
	...
	public function duzenle($id)
	{
		...
		$this->load->view('admin/medya_duzenle',$data);
