...
class Guncel extends CI_Controller {
	...
	{
		$query=$this->db->query("SELECT * FROM menu_alt where parent_id=3");
		...
		$this->load->view('admin/guncel_listele',$data);
...
$query=$this->db->query("SELECT * FROM siteayarlari");
		...
		$this->load->view('admin/guncel_ekle',$data);
...
$query=$this->db->query("SELECT * FROM siteayarlari");
		...
		if ( !$this->upload->do_upload('menu_alt_resim'))//bu resim formdaki name="resim" den geliyor
        ...
        else
            {
			   ...
			   redirect(base_url()."admin/guncel");
...
$query=$this->db->query("SELECT * FROM siteayarlari");
		...
		$this->load->view('admin/guncel_duzenle',$data);
