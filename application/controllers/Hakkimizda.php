...
$query=$this->db->query("SELECT * FROM menu where menu_durum=1 and menu_id=1");
		...
		$query=$this->db->query("SELECT * FROM menu_alt inner join menu on menu.parent_id=menu_alt.parent_id where menu_alt.parent_id=4 order by menu_alt_id asc ");
...
$query=$this->db->query("SELECT * FROM resim inner join menu on resim.menu_id=menu.menu_id where menu.menu_id=5 ");
		$data["x"]=$query->result();

		$query=$this->db->query("SELECT * FROM siteayarlari");
		$data["v"]=$query->result();
		$query=$this->db->query("SELECT menu_adi from menu where parent_id=4");
