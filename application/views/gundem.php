			...
			<div class="banner-title-content">
	        	<div class="text-center">
		        	...
		        	<ul class="breadcrumb">
			            ...
			            <li><a href="<?=base_url()?>guncel"><?=$veriler[0]->menu_adi?></a></li>
		          	</ul>
	          	</div>
				...
				<div class="col-sm-4 portfolio-static-item">
					...
					<div class="grid">
						...
						<figure class="effect-oscar">
							...
							<figcaption>
								<a class="link icon-pentagon" href="<?=base_url()?>guncel/altgetir/<?=$rs->menu_alt_id?>"><i class="fa fa-link"></i></a>
						...
						<div class="portfolio-static-desc">
							...
							<span><a href="<?=base_url()?>guncel/altgetir/<?=$rs->menu_alt_id?>"><?=$rs->menu_alt_adi?></a></span>
						</div>					
					</div><!--/ grid end -->
