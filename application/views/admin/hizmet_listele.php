...
<div class="row mb-3">
                                    ...
                                    <div class="col-lg-3 ">
                                         <a href="<?=base_url()?>admin/hizmet/ekle" class="btn btn-success btn-success"><i class=" fas fa-edit"></i>Yeni hizmet ekle</a> 
                                    </div>
                                </div>
...
<a href="<?=base_url()?>admin/hizmet/duzenle/<?=$rs->menu_alt_id?>" class="btn btn-info btn-info"><i class=" fas fa-edit"></i></a> 




<a href="<?=base_url()?>admin/hizmet/sil/<?=$rs->menu_alt_id?>" class="btn btn-danger btn-danger"   onclick="return confirm('Silinecek! Son Kararın mı?');" role="button"   ><i class="fas fa-trash-alt"></i></a> 
