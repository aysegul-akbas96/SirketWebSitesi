             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"><?=$menualt_ad[0]->menu_adi?> Yönetimi</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" autocomplete="off"  enctype="multipart/form-data"  action="<?=base_url()?>admin/menualt/ekle_kaydet/<?=$menualt_ad[0]->parent_id?>" role="form">
                               

                                 <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label"><?=$menualt_ad[0]->menu_adi?> Adı</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="parent_id" value="<?=$menualt_ad[0]->parent_id?>"  class="form-control" id="email1" placeholder="<?=$menualt_ad[0]->parent_id?>">
                                        </div>
                                </div>
