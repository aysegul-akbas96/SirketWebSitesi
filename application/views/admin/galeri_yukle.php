                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
							          ...
							          <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url()?>admin/menu/galeri_kaydet/<?=$id?>" role="form">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                ...
                                <div class="el-card-content">
                                    <a href="<?=base_url()?>admin/menu/galeri_sil/<?=$id?>/<?=$rs->resim_id?>" class="btn btn-danger btn-danger"   onclick="return confirm('Silinecek! Son Kararın mı?');" role="button"   ><i class="fas fa-trash-alt"> Resmi Sil</i></a> 
                                </div>
                            </div>
                        </div>
                    </div>
