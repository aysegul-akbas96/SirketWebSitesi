                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
							          ...
							          <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url()?>admin/menu/resim_kaydet/<?=$id?>" role="form">
                          ...
                          <img height="150" width="150" src="<?=base_url()?>uploads/<?=$veri[0]->menu_resim?>">
