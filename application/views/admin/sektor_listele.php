             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"><?=$s[0]->menu_adi?> Yönetimi</h4>
...
<div class="row mb-3">
                                    ...
                                    <div class="col-lg-3 ">
                                         <a href="<?=base_url()?>admin/sektor/ekle?>" class="btn btn-success btn-success"><i class=" fas fa-edit"></i>Yeni sektör ekle</a> 
                                    </div>
                                </div>
...
<a href="<?=base_url()?>admin/sektor/duzenle/<?=$rs->menu_alt_id?>" class="btn btn-info btn-info"><i class=" fas fa-edit"></i></a> 




<a href="<?=base_url()?>admin/sektor/sil/<?=$rs->menu_alt_id?>" class="btn btn-danger btn-danger"   onclick="return confirm('Silinecek! Son Kararın mı?');" role="button"   ><i class="fas fa-trash-alt"></i></a> 
