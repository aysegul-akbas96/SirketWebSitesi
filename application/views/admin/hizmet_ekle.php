            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" autocomplete="off"  enctype="multipart/form-data"  action="<?=base_url()?>admin/hizmet/ekle_kaydet" role="form">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="parent_id" value="1"  class="form-control" id="email1" placeholder="1">
                                        </div>
                                </div>
