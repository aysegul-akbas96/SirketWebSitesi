             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"><?=$hakki[0]->menu_adi?> Yönetimi</h4>
...
<div class="row mb-3">
                                    ...
                                    <div class="col-lg-3 ">
                                         <a href="<?=base_url()?>admin/hakkimizda/ekle" class="btn btn-success btn-success"><i class=" fas fa-edit"></i>Hakkımızda Ekle</a> 
                                    </div>
                                </div>
...
<a href="<?=base_url()?>admin/hakkimizda/duzenle/<?=$rs->menu_alt_id?>" class="btn btn-info btn-info"><i class=" fas fa-edit"></i></a> 




<a href="<?=base_url()?>admin/hakkimizda/sil/<?=$rs->menu_alt_id?>" class="btn btn-danger btn-danger"   onclick="return confirm('Silinecek! Son Kararın mı?');" role="button"   ><i class="fas fa-trash-alt"></i></a> 
